...
from app.core.permissions import require_permission, get_user_authorized_districts, resolve_authorized_districts
...
async def get_dashboard(
    ...
    summary = await service.get_dashboard_summary(authorized_districts=resolve_authorized_districts(auth_districts))
    return summary
