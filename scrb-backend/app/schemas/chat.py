...
class ChatResponse(BaseModel):
    ...
    execution_time_ms: float = Field(..., ge=0, description="Query execution time (ms).")
    ...
    confidence: float = Field(..., ge=0, le=1, description="Heuristic confidence score.")
...
class ChatErrorResponse(BaseModel):
    ...
    generated_sql: str | None = Field(default=None, description="SQL if generated before failure.")
